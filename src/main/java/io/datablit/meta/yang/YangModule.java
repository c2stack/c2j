...
public class YangModule {
    ...
    static {
        ...
        }
        {
            ...
            ChoiceCase case2 = ccase(body, "node");
            Container list = contr(case2, "node");
            ...
            ChoiceCase case4 = ccase(body, "leaf-node");
            Container leafList = contr(case4, "leaf-node");
    ...
    static Leaf leaf(MetaCollection parent, String ident, String type) {
        ...
        child.setDataType(new DataType(child, type));
        parent.addMeta(child);
        return child;
    }
